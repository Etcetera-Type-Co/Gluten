...
#echo "Generating VFs"
#fontmake -g Gluten.glyphs -o variable --output-path ../fonts/Gluten[slnt,wght].ttf
...
fontmake  -g Gluten.glyphs -o variable --output-path ../fonts/variable/GlutenVariable.ttf
...
woff2_compress GlutenVariable.ttf
